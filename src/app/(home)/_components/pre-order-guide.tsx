...
const steps = [
  ...
  },
  {
    ...
    title: "Receive Fresh",
    description:
      "Get your fresh, premium quality products delivered right to your doorstep.",
    color: "text-orange-600",
    bgColor: "bg-orange-100 dark:bg-orange-900/20",
  },
];

export const PreOrderGuide = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Follow our simple pre-order process to browse, add to cart, place
            your order, and receive your fresh, premium quality products.
          </p>
        </div>
            ...
            return (
              <div key={index} className="relative flex flex-col">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-30">
                  <div
                    className="size-10 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm
                    font-bold shadow-lg border-3 border-background
                    "
                  >
                    {step.step}
                  </div>
                ...
                <Card className="border-0 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.02] group h-full bg-card/50 backdrop-blur-sm relative overflow-visible cursor-pointer">
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:flex absolute top-1/2 -right-4 transform -translate-y-1/2 translate-x-1/2 z-20 items-center">
                    <div className="w-6 h-0.5 bg-linear-to-r from-primary/50 to-primary/30"></div>
                    <div className="w-0 h-0 border-l-8 border-l-primary/50 border-t-[5px] border-t-transparent border-b-[5px] border-b-transparent ml-0.5"></div>
                  </div>
                )}
              </div>
            );
        ...
        {/* Additional Info */}
        <div className="bg-linear-to-rfrom-primary/10 to-accent/10 rounded-2xl p-8 text-center backdrop-blur-sm border border-primary/10">
          <h3 className="text-2xl font-serif font-bold mb-4">
            Cash on Delivery Available
          </h3>
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto leading-relaxed">
            No need for advance payment! Pay conveniently when you receive your
            order. We accept cash payments upon delivery for your peace of mind.
          </p>
