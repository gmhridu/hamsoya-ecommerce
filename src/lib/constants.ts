...
export const COMPANY_INFO = {
  ...
  description:
    "Premium quality organic food products delivered fresh to your doorstep",
...
export const SEO_DEFAULTS = {
  ...
  description:
    "Discover premium quality organic food products including pure ghee, natural honey, and traditional spices. Fresh delivery across Bangladesh.",
  keywords:
    "organic food, pure ghee, natural honey, spices, traditional food, Bangladesh, online grocery",
